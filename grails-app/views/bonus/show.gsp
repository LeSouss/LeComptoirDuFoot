...
<html>
    ...
    <body>
        ...
        <div id="show-bonus" class="content scaffold-show" role="main">
            ...
            <f:display bean="bonus" />
            <g:form resource="${this.bonus}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.bonus}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
